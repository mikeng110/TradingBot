...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.currency_combo = QtWidgets.QComboBox(self.Transaction_gbx)
        self.currency_combo.setGeometry(QtCore.QRect(380, 70, 69, 22))
        self.currency_combo.setObjectName("currency_combo")
