...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Exchanges_gbx = QtWidgets.QGroupBox(self.centralwidget)
        self.Exchanges_gbx.setGeometry(QtCore.QRect(10, 10, 471, 141))
        self.Exchanges_gbx.setObjectName("Exchanges_gbx")
        self.Login_Status_Display_lbl = QtWidgets.QLabel(self.Exchanges_gbx)
        ...
        self.Login_Connect_btn = QtWidgets.QPushButton(self.Exchanges_gbx)
        self.Login_Connect_btn.setGeometry(QtCore.QRect(380, 110, 75, 23))
        self.Login_Connect_btn.setObjectName("Login_Connect_btn")
        self.Exchanges_cmbx = QtWidgets.QComboBox(self.Exchanges_gbx)
        self.Exchanges_cmbx.setGeometry(QtCore.QRect(10, 20, 311, 22))
        self.Exchanges_cmbx.setObjectName("Exchanges_cmbx")
        self.Exchanges_cmbx.addItem("")
        self.Exchanges_cmbx.addItem("")
        self.Exchanges_cmbx.addItem("")
        self.Exchanges_cmbx.addItem("")
        self.Paper_trade_chbx = QtWidgets.QCheckBox(self.Exchanges_gbx)
        self.Paper_trade_chbx.setGeometry(QtCore.QRect(290, 110, 81, 17))
        ...
        self.Strategy_gbx.setGeometry(QtCore.QRect(10, 170, 471, 141))
        ...
        self.menuExchanges = QtWidgets.QMenu(self.menubar)
        self.menuExchanges.setObjectName("menuExchanges")
        ...
        self.Menu_Exchange_View = QtWidgets.QAction(MainWindow)
        self.Menu_Exchange_View.setObjectName("Menu_Exchange_View")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Exchanges_gbx.setTitle(_translate("MainWindow", "Exchanges"))
        ...
        self.Exchanges_cmbx.setItemText(0, _translate("MainWindow", "Binance"))
        self.Exchanges_cmbx.setItemText(1, _translate("MainWindow", "Unknown"))
        self.Exchanges_cmbx.setItemText(2, _translate("MainWindow", "Something Else"))
        self.Exchanges_cmbx.setItemText(3, _translate("MainWindow", "Coinbase"))
        ...
        self.menuExchanges.setTitle(_translate("MainWindow", "Exchanges"))
        ...
        self.Menu_Exchange_View.setText(_translate("MainWindow", "Exchange Manager"))
